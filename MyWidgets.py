...
class RoundedButton(RoundedWidget):
    ...
    def setBackgroundColor(self, a0: int | QtGui.QColor, a1: int | None = None, a2: int | None = None, a3: int | None = None) -> None:
        if isinstance(a0, int) and isinstance(a1, int) and isinstance(a2, int) and (isinstance(a3, int) or a3 is None):
            if a3 is not None:
                self.__standard_color["a"] = a3
            else:
                self.__standard_color["a"] = 255
            self.__standard_color["r"] = a0
            self.__standard_color["g"] = a1
            self.__standard_color["b"] = a2
        elif isinstance(a0, QtGui.QColor) and a1 is None and a2 is None and a3 is None:
            self.__standard_color["r"] = a0.red()
            self.__standard_color["g"] = a0.green()
            self.__standard_color["b"] = a0.blue()
            self.__standard_color["a"] = a0.alpha()
        else:
            raise TypeError("Parameter passed error!")
    ...
    def setEnteredColor(self, a0: int | QtGui.QColor, a1: int | None = None, a2: int | None = None, a3: int | None = None) -> None:
        if isinstance(a0, int) and isinstance(a1, int) and isinstance(a2, int) and (isinstance(a3, int) or a3 is None):
            if a3 is not None:
                self.__entered_color["a"] = a3
            else:
                self.__entered_color["a"] = 255
            self.__entered_color["r"] = a0
            self.__entered_color["g"] = a1
            self.__entered_color["b"] = a2
        elif isinstance(a0, QtGui.QColor) and a1 is None and a2 is None and a3 is None:
            self.__entered_color["r"] = a0.red()
            self.__entered_color["g"] = a0.green()
            self.__entered_color["b"] = a0.blue()
            self.__entered_color["a"] = a0.alpha()
        else:
            raise TypeError("Parameter passed error!")
    ...
    def setPressedColor(self, a0: int | QtGui.QColor, a1: int | None = None, a2: int | None = None, a3: int | None = None) -> None:
        if isinstance(a0, int) and isinstance(a1, int) and isinstance(a2, int) and (isinstance(a3, int) or a3 is None):
            if a3 is not None:
                self.__pressed_color["a"] = a3
            else:
                self.__pressed_color["a"] = 255
            self.__pressed_color["r"] = a0
            self.__pressed_color["g"] = a1
            self.__pressed_color["b"] = a2
        elif isinstance(a0, QtGui.QColor) and a1 is None and a2 is None and a3 is None:
            self.__pressed_color["r"] = a0.red()
            self.__pressed_color["g"] = a0.green()
            self.__pressed_color["b"] = a0.blue()
            self.__pressed_color["a"] = a0.alpha()
        else:
            raise TypeError("Parameter passed error!")
